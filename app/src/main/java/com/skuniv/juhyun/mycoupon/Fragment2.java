...
public class Fragment2 extends Fragment
{
    ...
    {
        FrameLayout layout = (FrameLayout) inflater.inflate(R.layout.fragment_second, container, false);
//        ivCard = (ImageView)layout.findViewById(R.id.card2);
